...
public class AdrressSQLRepository {
    private final String TAG = "UserSQLRepository";
    private static AdrressSQLRepository instance;
    private Context contexto;
    private SQLiteDatabase database;

    public static AdrressSQLRepository getInstance(Context contexto) {
        if (instance == null) {
            instance = new AdrressSQLRepository(contexto);
        }
        return instance;
    }

    private AdrressSQLRepository(Context contexto) {
        super();
